...
func (ec *executionContext) _Query_GetAllPosts(ctx context.Context, field graphql.CollectedField) (ret graphql.Marshaler) {
	...
	res := resTmp.([]*models.Post)
	fc.Result = res
	return ec.marshalNPost2ᚕᚖmy_appᚋinternalᚋmodelsᚐPostᚄ(ctx, field.Selections, res)
}
...
func (ec *executionContext) _Query_GetPostById(ctx context.Context, field graphql.CollectedField) (ret graphql.Marshaler) {
	...
	fc.Result = res
	return ec.marshalNPostDetails2ᚖmy_appᚋinternalᚋmodelsᚐPostDetails(ctx, field.Selections, res)
}
...
func (ec *executionContext) marshalNPost2ᚕᚖmy_appᚋinternalᚋmodelsᚐPostᚄ(ctx context.Context, sel ast.SelectionSet, v []*models.Post) graphql.Marshaler {
	...
	for i := range v {
		...
		f := func(i int) {
			...
			ret[i] = ec.marshalNPost2ᚖmy_appᚋinternalᚋmodelsᚐPost(ctx, sel, v[i])
		}
		if isLen1 {
			f(i)
		} else {
...
func (ec *executionContext) marshalNPostDetails2my_appᚋinternalᚋmodelsᚐPostDetails(ctx context.Context, sel ast.SelectionSet, v models.PostDetails) graphql.Marshaler {
	return ec._PostDetails(ctx, sel, &v)
}

func (ec *executionContext) marshalNPostDetails2ᚖmy_appᚋinternalᚋmodelsᚐPostDetails(ctx context.Context, sel ast.SelectionSet, v *models.PostDetails) graphql.Marshaler {
	if v == nil {
		if !graphql.HasFieldError(ctx, graphql.GetFieldContext(ctx)) {
			ec.Errorf(ctx, "the requested element is null which the schema does not allow")
		}
